...
const contentClasses = {
  ...
  container: "bg-[#ffeed0] dark:bg-[#313338] dark:text-white md:col-start-2 md:col-span-2 md:h-full max-md:min-h-full",
  prose: "prose dark:prose-invert px-4 md:px-8 pt-2 md:pt-8"
};

...
const indexNavClasses = {
  ...
  byteswap: {
    logoandtext:
      "p-6 md:p-0 w-full md:w-2/3 lg:w-1/2 xl:w-1/3 2xl:w-1/4 md:mx-auto",
    justlogo: "hidden",
  },
  pagelinkscontainer:
    ...
    <div className={navClasses.container}>
      <div className={navClasses.linkscontainer}>
        <Link to="/" className={navClasses.byteswap.link}>
          <ByteswapLogo
            id="Byteswap Logo"
            aria-label="Byteswap Logo"
            className={navClasses.byteswap.justlogo}
          />
          <Byteswap
            id="Byteswap Labs"
            aria-label="Byteswap Labs"
            className={navClasses.byteswap.logoandtext}
          />
        </Link>
        <div className={navClasses.pagelinkscontainer}>
          ...
          >
            ...
            />
            <span
              className={`${navClasses.page.text} ${navClasses.games.text}`}
            >
              Games
            </span>
          </Link>
          <Link
            to="/about"
            className={`${navClasses.page.link} ${navClasses.about.link}`}
          >
            <FaBookAtlas
              className={`${navClasses.page.icon} ${navClasses.about.icon}`}
            />
            <span
              className={`${navClasses.page.text} ${navClasses.about.text}`}
            >
              About
            </span>
          </Link>
          <Link
            to="/socials"
            className={`${navClasses.page.link} ${navClasses.socials.link}`}
          >
            <MdAlternateEmail
              className={`${navClasses.page.icon} ${navClasses.socials.icon}`}
            />
            <span
              className={`${navClasses.page.text} ${navClasses.socials.text}`}
            >
              Socials
            </span>
          </Link>

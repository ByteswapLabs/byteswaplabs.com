...
Using binary modification techniques Byteswap Labs created a brand new build of Tomb Raider 4-5 for this Evercade cartridge. Using reverse engineering, we also added the bonus level "The Times" for the first time on an official PS1 build of the game!

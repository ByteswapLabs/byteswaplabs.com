...
modified from https://github.com/adam-p/markdown-here.wiki.git to not break the build, not everything is rendering correctly but it does a good job of showing us what works and what doesn't
